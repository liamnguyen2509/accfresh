    ...
    return(
        <div className={`${classes["confirm-modal"]} ${classes["confirm-modal-open"]}`}>
            <div className={classes.content}>
                ...
                <p className="heading-S">This group {props.groupName} and all products belong to it will be deleted.</p>
                <p className="heading-S">Do you want to continue removing?</p>
            </div>
